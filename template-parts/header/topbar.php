...
$pwt_topbar_text = function_exists('wildtours_nav_topbar_text')
    ? wildtours_nav_topbar_text()
    : (string) get_theme_mod('topbar_text', '');

$pwt_header_cta = function_exists('wildtours_nav_header_cta')
    ? wildtours_nav_header_cta()
    : [
        'label' => (string) get_theme_mod('header_cta_label', ''),
        'url'   => (string) get_theme_mod('header_cta_url', ''),
    ];

$pwt_cta_label = (string) ($pwt_header_cta['label'] ?? '');
$pwt_cta_url = (string) ($pwt_header_cta['url'] ?? '');
